console.log('svg js is loaded');

function test(){
  console.log('in the test fx in svg js');
}
...
//                 console.log('4');
//                  path.animate({ d:
//                    d="M-0.5,0.5v720h1024V0.5H-0.5z M279.326,381.696c-62.759,62.759-80.18,34.2-93.723,23.126c-55.007-44.976-12.807,59.289-65.728,74.248c-52.796,14.924-121.064-5.123-52.339-165.537c35.655-83.224,3.203-35.876-2.052-116.017c-5.255-80.141-50.979-88.556,58.042-107.945c150.307-26.731,46.743,84.765,159.451,34.081c71.341-32.082,45.635,64.019,23.126,144.845C279.326,364.656,323.145,337.878,279.326,381.696z"
//                   },
//                    4000,
//                    mina.easein,
//                  //  5
